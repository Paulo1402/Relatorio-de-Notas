...
"            ")
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/assets/save-48.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_save.setIcon(icon6)
        self.bt_save.setIconSize(QSize(48, 48))

        self.horizontalLayout_2.addWidget(self.bt_save)

        self.bt_clear = QPushButton(self.pg_register)
        ...
        self.bt_clear.setMinimumSize(QSize(70, 70))
        self.bt_clear.setCursor(QCursor(Qt.PointingHandCursor))
        icon7 = QIcon()
        icon7.addFile(u":/icons/assets/erase-48.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_clear.setIcon(icon7)
        self.bt_clear.setIconSize(QSize(48, 48))
        ...
        self.bt_clear_search.setIcon(icon7)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icons/assets/search-48.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_search.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/assets/pdf-48.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_pdf.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/assets/print-48.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_print.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/assets/registry-48.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_register_menu.setIcon(icon12)
        ...
        self.bt_search_menu.setIcon(icon9)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/assets/export-48.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_export_menu.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/icons/assets/db.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menu_db.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/icons/assets/themes-32.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menu_theme.setIcon(icon15)
        ...
        QWidget.setTabOrder(self.txt_nfe, self.cb_supplier)
...
#if QT_CONFIG(tooltip)
        self.bt_clear.setToolTip(QCoreApplication.translate("MainWindow", u"LIMPAR", None))
#endif // QT_CONFIG(tooltip)
